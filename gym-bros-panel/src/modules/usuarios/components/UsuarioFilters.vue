...
defineEmits(['update:busqueda', 'update:estado', 'limpiar'])

const filtrosActivos = computed(() => props.busqueda.trim() || props.estado !== 'all')
</script>
...
.filtros {
  display: grid;
  grid-template-columns: minmax(17rem, 2fr) minmax(8.5rem, 1fr) auto;
  align-items: end;
  gap: 0.75rem;
  padding: 0.875rem;
