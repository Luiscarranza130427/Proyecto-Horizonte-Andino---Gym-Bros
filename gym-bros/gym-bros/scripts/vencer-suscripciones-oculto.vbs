Option Explicit
' Ejecuta "php artisan suscripciones:vencer" oculto y agrega la salida a storage\logs\suscripciones-vencimiento.log.
...
If WScript.Arguments.Count = 1 Then
    ...
    args = " --simular"
End If
command = "& '" & php & "' artisan suscripciones:vencer --no-interaction --no-ansi" & args & " *>> '" & raiz & "\storage\logs\suscripciones-vencimiento.log'; exit $LASTEXITCODE"
