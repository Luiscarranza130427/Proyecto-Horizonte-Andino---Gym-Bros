Option Explicit
' Ejecuta "php artisan usuarios:recordar-suscripcion" oculto y agrega la salida a storage\logs\recordatorios-suscripcion.log.
...
If WScript.Arguments.Count = 1 Then
    ...
    args = " --simular"
End If
command = "& '" & php & "' artisan usuarios:recordar-suscripcion --no-interaction --no-ansi" & args & " *>> '" & raiz & "\storage\logs\recordatorios-suscripcion.log'; exit $LASTEXITCODE"
