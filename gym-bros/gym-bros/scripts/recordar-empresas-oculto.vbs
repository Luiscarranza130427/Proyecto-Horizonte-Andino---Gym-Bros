Option Explicit
' Ejecuta "php artisan empresas:recordar-suscripcion" oculto y agrega la salida a storage\logs\recordatorios-empresas.log.
...
If WScript.Arguments.Count = 1 Then
    ...
    args = " --simular"
End If
command = "& '" & php & "' artisan empresas:recordar-suscripcion --no-interaction --no-ansi" & args & " *>> '" & raiz & "\storage\logs\recordatorios-empresas.log'; exit $LASTEXITCODE"
