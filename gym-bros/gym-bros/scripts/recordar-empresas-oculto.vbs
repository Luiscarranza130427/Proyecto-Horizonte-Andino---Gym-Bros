...
If WScript.Arguments.Count = 1 Then
    ...
    args = " --simular"
End If
command = "& 'C:\laragon\bin\php\php-8.3.33-Win32-vs16-x64\php.exe' artisan empresas:recordar-suscripcion --no-interaction --no-ansi" & args & " *>> 'C:\laragon\www\gym-bros\storage\logs\recordatorios-empresas.log'; exit $LASTEXITCODE"
